...
import 'package:foo/src/presentation/pages/home/home_page.dart';
...
final routerConfig = GoRouter(
  ...
  observers: [
    if (BuildConfig.values().isFirebaseEnabled) FirebaseAnalyticsObserver(analytics: FirebaseAnalytics.instance),
  ],
  routes: [
    GoRoute(
